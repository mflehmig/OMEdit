...
QString Helper::simulateWithAnimation = "Simulates the model and generates the visualization XML file";
QString Helper::simulateWithAnimationTip = "Simulates the model and generates the visualization XML file";
